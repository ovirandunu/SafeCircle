import svgPaths from "./svg-l0zj6lq8y0";
...
function Container2() {
  return (
    <div className="absolute bg-[#fff5f0] content-stretch flex flex-col h-[1012px] items-start left-0 pb-0 pt-[60px] px-[60px] top-0 w-[1433px]" data-name="Container">
      <Container1 />
    </div>
  );
}
...
function Container29() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[757px] items-center left-[913px] overflow-clip p-[8px] rounded-[32px] shadow-[0px_0px_1px_0px_rgba(24,24,27,0.3),0px_8px_16px_0px_rgba(24,24,27,0.1)] top-[119px] w-[351px]" data-name="Container">
      <Container14 />
      <Container26 />
      <StatusBarIPhone />
      <Container28 />
...
export default function Frame1() {
  return (
    <div className="bg-white relative size-full">
      <Container2 />
      <div className="absolute bg-white border-2 border-black border-solid h-[870px] left-[804px] rounded-[32px] shadow-[0px_0px_1px_0px_rgba(24,24,27,0.3),0px_8px_16px_0px_rgba(24,24,27,0.1)] top-[69px] w-[563px]" />
      <Container29 />
    </div>
  );
}