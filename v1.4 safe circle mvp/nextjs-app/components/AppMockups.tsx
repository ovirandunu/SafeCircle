...
import svgPaths from '@/components/imports/svg-hencj1gkca';
...
// Wrapper with interesting layout - content on left, phone on right
interface MockupWithContentProps {
  title: string;
  description: string;
...
function MockupWithContent({ title, description, children, reverse = false }: MockupWithContentProps) {
  return (
    <div className={`flex ${reverse ? 'flex-row-reverse' : 'flex-row'} items-center gap-[60px] mb-[80px]`}>
      {/* Text content - no background, just aligned */}
      <div className="flex-1">
        ...
        <p className="font-['Open_Sans:Regular',sans-serif] text-[18px] leading-[28px] text-[#838383] max-w-[509px]" style={{ fontVariationSettings: "'wdth' 100" }}>
          {description}
        </p>
      </div>
      
      {/* Phone mockup in a bordered box with gradient */}
      <div className="flex-shrink-0">
        <div 
          className="w-[563px] h-[870px] rounded-[32px] border-[2px] border-black shadow-[0px_0px_1px_0px_rgba(24,24,27,0.3),0px_8px_16px_0px_rgba(24,24,27,0.1)] flex items-center justify-center p-[60px]"
          style={{ 
...
export function DailyCheckInMockup() {
  return (
    <div className="bg-white rounded-[32px] overflow-hidden shadow-[0px_0px_1px_0px_rgba(24,24,27,0.3),0px_8px_16px_0px_rgba(24,24,27,0.1)] w-[393px] h-[852px] flex flex-col border-[3px] border-black">
      <IOSStatusBar />
      ...
      <div className="flex-1 overflow-hidden">
        <div className="px-[24px] py-[24px] bg-[#fff5f0] h-full overflow-y-auto">
          {/* Date */}
          ...
          {/* Trusted contacts */}
          <div className="bg-white border-[2px] border-black rounded-[12px] p-[20px] mb-[24px]">
          ...
          {/* Recent Activity */}
          <div className="bg-white border-[2px] border-black rounded-[12px] p-[20px] mb-[100px]">
            <h3 className="font-['Open_Sans:SemiBold',sans-serif] text-[16px] text-[#323232] mb-[16px]">Recent Activity</h3>
            <div className="space-y-[12px]">
              <div className="flex items-center gap-[12px]">
                <div className="w-[8px] h-[8px] bg-[#4caf50] rounded-full"></div>
                <span className="font-['Open_Sans:Regular',sans-serif] text-[13px] text-[#323232]">Check-in at 8:15 AM</span>
              </div>
              <div className="flex items-center gap-[12px]">
                <div className="w-[8px] h-[8px] bg-[#4caf50] rounded-full"></div>
                <span className="font-['Open_Sans:Regular',sans-serif] text-[13px] text-[#323232]">Check-in at 7:30 PM (yesterday)</span>
              </div>
            </div>
          </div>
        </div>
...
export function MissedCheckInMockup() {
  return (
    <div className="bg-white rounded-[32px] overflow-hidden shadow-[0px_0px_1px_0px_rgba(24,24,27,0.3),0px_8px_16px_0px_rgba(24,24,27,0.1)] w-[393px] h-[852px] flex flex-col border-[3px] border-black">
      <IOSStatusBar />
      ...
      {/* Screen content - scrollable area */}
      <div className="flex-1 overflow-hidden">
        <div className="px-[24px] pt-[40px] pb-[24px] bg-[#fff5f0] h-full overflow-y-auto">
          {/* Date */}
          <div className="mb-[24px]">
            <p className="font-['Open_Sans:Regular',sans-serif] text-[14px] text-[#838383]" style={{ fontVariationSettings: "'wdth' 100" }}>Today, Dec 30</p>
          </div>
          ...
          {/* Actions section that extends below nav */}
          <div className="bg-white border-[2px] border-black rounded-[12px] p-[20px] mb-[100px]">
            <h3 className="font-['Open_Sans:SemiBold',sans-serif] text-[16px] text-[#323232] mb-[16px]">Quick Actions</h3>
            <button className="w-full bg-[#f8918a] text-white py-[12px] px-[16px] rounded-[8px] border-[2px] border-black font-['Open_Sans:SemiBold',sans-serif] text-[14px] mb-[8px]">
              I'm okay - Cancel alert
            </button>
            <button className="w-full bg-white text-[#323232] py-[12px] px-[16px] rounded-[8px] border-[2px] border-black font-['Open_Sans:SemiBold',sans-serif] text-[14px]">
              Contact support
            </button>
          </div>
        </div>
...
export function LegacyOverviewMockup() {
  return (
    <MockupWithContent
      title="Everything important is organized and ready"
      description="Keep all your essential information in one secure place. From financial accounts to personal wishes, everything is accessible when it matters most."
      reverse={false}
    >
      <div className="bg-white rounded-[32px] overflow-hidden shadow-[0px_0px_1px_0px_rgba(24,24,27,0.3),0px_8px_16px_0px_rgba(24,24,27,0.1)] w-[393px] h-[852px] flex flex-col">
        <IOSStatusBar />
        ...
        <div className="flex-1 overflow-hidden">
          <div className="px-[24px] py-[24px] bg-[#fff5f0] h-full overflow-y-auto">
            ...
            <div className="space-y-[12px] mb-[100px]">
              ...
              <div className="bg-white border-[2px] border-black rounded-[12px] p-[16px] flex items-center justify-between">
                <div className="flex items-center gap-[12px]">
                  ...
                  <div>
                    <p className="font-['Open_Sans:SemiBold',sans-serif] text-[14px] text-[#323232]">Documents</p>
                    <p className="font-['Open_Sans:Regular',sans-serif] text-[12px] text-[#838383]">8 files</p>
                  </div>
                </div>
                <div className="w-[20px] h-[20px] bg-[#e8f5e9] rounded-full flex items-center justify-center">
                  <CheckCircle className="w-[14px] h-[14px] text-[#4caf50]" />
              ...
              <div className="bg-white border-[2px] border-black rounded-[12px] p-[16px] flex items-center justify-between">
                <div className="flex items-center gap-[12px]">
                  ...
                  <div>
                    <p className="font-['Open_Sans:SemiBold',sans-serif] text-[14px] text-[#323232]">Personal Wishes</p>
              ...
              <div className="bg-white border-[2px] border-black rounded-[12px] p-[16px] flex items-center justify-between">
                <div className="flex items-center gap-[12px]">
                  <div className="w-[40px] h-[40px] bg-[#fff5f0] rounded-[8px] flex items-center justify-center border-[2px] border-black">
                    <Home className="w-[20px] h-[20px] text-[#f8918a]" />
                  </div>
                  <div>
                    <p className="font-['Open_Sans:SemiBold',sans-serif] text-[14px] text-[#323232]">Property Details</p>
                    <p className="font-['Open_Sans:Regular',sans-serif] text-[12px] text-[#838383]">2 properties</p>
                  </div>
                </div>
                <div className="w-[20px] h-[20px] bg-[#e8f5e9] rounded-full flex items-center justify-center">
                  <CheckCircle className="w-[14px] h-[14px] text-[#4caf50]" />
