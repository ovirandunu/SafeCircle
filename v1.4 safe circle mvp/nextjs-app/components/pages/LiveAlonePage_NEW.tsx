...
// Map Figma asset hashes to actual images
const heroImage = getFigmaAsset('85986970382cf0787f06862b543e8b8721cd944f');
const privacySettingsImg = getFigmaAsset('5281bbf7203d7edc283b0480d1a623279c50ec88');
const appBehaviorImg = getFigmaAsset('f100685f2e801659d2e2c586a55e2117b513f336');
const mySafeCircleImg = getFigmaAsset('54848f75f286af6996dc757a152776243a12d2f0');
const allIsWellImg = getFigmaAsset('3667e12d220b43d714201c3bab28d2ace16828f5');
const concernImg = getFigmaAsset('897b4259652ab58e6acffb492924a70bda70573e');
