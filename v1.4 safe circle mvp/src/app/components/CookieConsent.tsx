  ...
  const applyConsent = (prefs: CookiePreferences) => {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (prefs.functional) {
        ...
        // Enable chat widgets, video players, etc.
      } else {
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white border-[2px] border-black rounded-[8px] p-4">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <Cookie className="w-5 h-5 text-[#f8918a]" />
                        <h4 className="font-['Open_Sans:SemiBold',sans-serif] text-[16px] text-[#323232]" style={{ fontVariationSettings: "'wdth' 100" }}>
                          {i18n.language === 'nl' ? 'Functionele Cookies' : 'Functional Cookies'}
                        </h4>
                      </div>
                      <p className="font-['Open_Sans:Regular',sans-serif] text-[13px] text-[#838383]" style={{ fontVariationSettings: "'wdth' 100" }}>
                        {i18n.language === 'nl'
                          ? 'Deze cookies maken uitgebreide functionaliteit mogelijk, zoals video\'s afspelen, livechat en voorkeuren onthouden.'
                          : 'These cookies enable enhanced functionality like playing videos, live chat, and remembering your preferences.'}
                      </p>
                    </div>
                    <div className="ml-4">
                      <button
                        ...
                        className={`w-12 h-6 rounded-full relative transition-colors ${
                          preferences.functional ? 'bg-[#f8918a]' : 'bg-[#e0e0e0]'
                        }`}
